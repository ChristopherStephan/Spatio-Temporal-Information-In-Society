...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>rpubs/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua at master · ChristopherStephan/rpubs</title>
...
<meta content="NXG7OGIch/ox/Mz+s4EChuLiF0NlZPSZ/sTCvL5yt0k=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-b95518dadd9fd57d8fb892270da34baed14530c4.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="6f6817f7edc3e64c7c6a02986ff4c698">
        ...
        <link data-pjax-transient rel='permalink' href='/ChristopherStephan/rpubs/blob/7dea1a9382a489102ba146737b6e1ebcdaa3186f/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua'>
...
<!-- blob contrib key: blob_contributors:v21:ff1e7d3685e39051bac5c840c7c7c3fd -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/ChristopherStephan/rpubs/blob/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
          ...
          <form accept-charset="UTF-8" action="/ChristopherStephan/rpubs/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="NXG7OGIch/ox/Mz+s4EChuLiF0NlZPSZ/sTCvL5yt0k=" /></div>
            ...
            <input type="hidden" name="path" id="branch" value="git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua" />
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton"
                   href="/ChristopherStephan/rpubs/edit/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/ChristopherStephan/rpubs/raw/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua" class="button minibutton " id="raw-url">Raw</a>
            <a href="/ChristopherStephan/rpubs/blame/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua" class="button minibutton ">Blame</a>
          <a href="/ChristopherStephan/rpubs/commits/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/ChristopherStephan/rpubs/delete/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise02.lua"
             title=""
...
<span id="L8" rel="#L8">8</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">-- Implement a function that takes an integer value</span></div><div class='line' id='LC2'><span class="c1">-- as argument and invert the order of its numerals.</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="kd">local</span> <span class="k">function</span> <span class="nf">invert</span><span class="p">(</span><span class="n">integer</span><span class="p">)</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="nb">tonumber</span><span class="p">(</span><span class="nb">string.reverse</span><span class="p">(</span><span class="nb">tostring</span><span class="p">(</span><span class="n">integer</span><span class="p">)))</span></div><div class='line' id='LC6'><span class="k">end</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="nb">print</span><span class="p">(</span><span class="n">invert</span><span class="p">(</span><span class="mi">531</span><span class="p">))</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.04692s from github-fe128-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
