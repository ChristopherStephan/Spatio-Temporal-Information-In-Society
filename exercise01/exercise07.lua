...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>rpubs/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua at master · ChristopherStephan/rpubs</title>
...
<meta content="NXG7OGIch/ox/Mz+s4EChuLiF0NlZPSZ/sTCvL5yt0k=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-b95518dadd9fd57d8fb892270da34baed14530c4.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="6f6817f7edc3e64c7c6a02986ff4c698">
        ...
        <link data-pjax-transient rel='permalink' href='/ChristopherStephan/rpubs/blob/7dea1a9382a489102ba146737b6e1ebcdaa3186f/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua'>
...
<!-- blob contrib key: blob_contributors:v21:9a493a026567681c1c291199c29223ba -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/ChristopherStephan/rpubs/blob/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
          ...
          <form accept-charset="UTF-8" action="/ChristopherStephan/rpubs/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="NXG7OGIch/ox/Mz+s4EChuLiF0NlZPSZ/sTCvL5yt0k=" /></div>
            ...
            <input type="hidden" name="path" id="branch" value="git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua" />
    ...
    <div class="meta">
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton"
                   href="/ChristopherStephan/rpubs/edit/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/ChristopherStephan/rpubs/raw/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua" class="button minibutton " id="raw-url">Raw</a>
            <a href="/ChristopherStephan/rpubs/blame/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua" class="button minibutton ">Blame</a>
          <a href="/ChristopherStephan/rpubs/commits/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/ChristopherStephan/rpubs/delete/master/git/Spatio-Temporal-Information-In-Society/exercise01/src/exercise07.lua"
             title=""
...
<span id="L11" rel="#L11">11</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c1">-- Write a Lua function that calculates the 50 first Fibonnaci numbers,</span></div><div class='line' id='LC2'><span class="c1">-- defined as F(n) = F(n-­‐1) + F(n-­‐2) with F(0) = 0 and F(1) = 1.</span></div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><span class="kd">local</span> <span class="k">function</span> <span class="nf">fibonacci</span><span class="p">(</span><span class="n">number</span><span class="p">)</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="n">number</span> <span class="o">&gt;</span> <span class="mi">1</span> <span class="k">then</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">number</span> <span class="o">=</span> <span class="n">fibonacci</span><span class="p">(</span><span class="n">number</span> <span class="o">-</span> <span class="mi">1</span><span class="p">)</span> <span class="o">+</span> <span class="n">fibonacci</span><span class="p">(</span><span class="n">number</span> <span class="o">-</span> <span class="mi">2</span><span class="p">)</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="n">number</span></div><div class='line' id='LC9'><span class="k">end</span></div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'><span class="nb">print</span><span class="p">(</span><span class="n">fibonacci</span><span class="p">(</span><span class="mi">7</span><span class="p">))</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.04857s from github-fe134-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
